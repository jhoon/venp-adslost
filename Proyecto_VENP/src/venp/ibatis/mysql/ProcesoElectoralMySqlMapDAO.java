...
public class ProcesoElectoralMySqlMapDAO extends SqlMapDaoTemplate implements ProcesoElectoralDAO {
	...
	public ArrayList findAll() throws Exception {
		return (ArrayList<ProcesoElectoralBean>) queryForList("ProcesoElectoral.findAll", null);
	}

	public ArrayList findAllCreado() throws Exception {
		return (ArrayList<ProcesoElectoralBean>) queryForList("ProcesoElectoral.findAll_Creado", null);
	}

	public ProcesoElectoralBean findByPrimaryKey(int id) throws Exception {
		return (ProcesoElectoralBean)this.queryForObject("ProcesoElectoral.findByKey", id);
	}
